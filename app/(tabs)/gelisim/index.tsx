...
import type { ExamRecord, ExamType } from '@/db/types';
...
export default function ProgressScreen() {
  ...
  const renderExam = useCallback(
    ({ item: exam, index }: { item: ExamRecord; index: number }) => {
    ...
    [allForType, colors, confirmDelete, i18n.language, router, t, typography],
  );
            ...
            {!latest ? (
              ...
              <>
                ...
                <Card>
                  ...
                  {breakdown.map((item) => {
                    const definition = examSections.find(
